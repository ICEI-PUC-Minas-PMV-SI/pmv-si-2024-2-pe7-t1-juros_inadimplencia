...
plt.title("Série Temporal - Endividamento total (Treinamento e Teste)")
plt.legend()
plt.xlabel("Período")
...
plt.figure(figsize=(12, 6))
plt.plot(dados_endiv['Endividamento_Total'], label="Histórico", color="blue")
...
plt.title("Previsão do Endividamento Total - Próximos 36 Meses")
plt.legend()
plt.xlabel("Período")
plt.ylabel("Endividamento Total")
plt.grid()
