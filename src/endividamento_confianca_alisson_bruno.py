...
x = dados[['Confiança_Valor']] #variável dependente (Indice de Confiança do Consumidor)
...
plt.xlabel("Indice de Confiança do Consumidor")
plt.ylabel("Endividamento SFN")
plt.legend()
plt.title("Regressão Linear - Endividamento SFN X Indice de Confiança do Consumidor")
